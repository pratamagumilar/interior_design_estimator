...
import { reactive, computed, mergeProps, withCtx, openBlock, createBlock, createVNode, createTextVNode, ref, watch, useSSRContext } from 'vue';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="summary-card glass" data-v-de22b9de><h2 class="section-title" data-v-de22b9de>Estimasi Biaya</h2><div class="summary-row" data-v-de22b9de><span data-v-de22b9de>Volume / Luas:</span><span data-v-de22b9de>${ssrInterpolate(volumeM2.value.toFixed(2))} m\xB2</span></div><div class="summary-row total" data-v-de22b9de><span data-v-de22b9de>Total Estimasi:</span><span class="price" data-v-de22b9de>${ssrInterpolate(formatCurrency(totalPrice.value))}</span></div><button class="btn-primary" data-v-de22b9de>Pesan Sekarang via WhatsApp</button></div></div></main></div>`);
    };
  }
};
...
export { kalkulator as default };
//# sourceMappingURL=kalkulator-BjE-M52-.mjs.map
